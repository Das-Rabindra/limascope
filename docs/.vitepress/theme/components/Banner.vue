<template>
  ...
  >
    <div class="mx-auto flex items-center gap-2 lg:gap-4">
      <span class="animate-bounce">🚀</span>K8s users, I need your help! I have added K8s support to Limascope and I need
      your feedback! 🙏
      <a
        href="https://github.com/Das-Rabindra/limascope/discussions/3614"
        target="_blank"

...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: "https://github.com/Das-Rabindra/limascope/edit/master/docs/:path",
    },
    nav: [
      { text: "Home", link: "/" },
      { text: "Guide", link: "/guide/what-is-dozzle", activeMatch: "/guide/" },
      {
        ...
        items: [
          {
            text: "Releases",
            link: "https://github.com/Das-Rabindra/limascope/releases",
          },
          {
            text: "New Issue",
            link: "https://github.com/Das-Rabindra/limascope/issues/new/choose",
          },
        ],
      },
    ],
    ...
    socialLinks: [
      { icon: "github", link: "https://github.com/Das-Rabindra/limascope" },
      {
        icon: {
